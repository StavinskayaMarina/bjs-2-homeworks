...
describe('Задача №2. Функция должна:', () => {
	...
	it('верно считать кредит: кейс #3', () => {
		expect(calculateTotalMortgage(10, 0, 20000, 24)).toEqual(22149.56);
	});

	it('верно считать кредит: кейс #4', () => {
		expect(calculateTotalMortgage(10, 1000, 20000, 24)).toEqual(21042.09);
	});

	it('верно считать кредит: кейс #5', () => {
		expect(calculateTotalMortgage(10, 20000, 20000, 24)).toEqual(0);
	});
